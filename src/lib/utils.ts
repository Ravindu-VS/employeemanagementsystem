 ...
 * Accepts 9-digit numbers (without leading 0) or 10-digit (with leading 0)
 */
export function isValidPhone(phone: string): boolean {
  const digits = phone.replace(/\D/g, '');
  // Sri Lankan mobile: 07X XXXX XXX (10 digits with leading 0)
  // or 7X XXXX XXX (9 digits without leading 0)
  // or with country code: 947XXXXXXXX (11 digits)
